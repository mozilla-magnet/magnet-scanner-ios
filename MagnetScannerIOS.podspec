#
#  Be sure to run `pod spec lint MagnetScannerIOS.podspec' to ensure this is a
...
Currently discovers urls based on the following protocols:
  ...
  s.homepage     = "https://github.com/mozilla-magnet/magnet-scanner-ios"
  ...
  s.author             = { "Fernando Jiménez Moreno" => "ferjmoreno@gmail.com" }
  # Or just: s.author    = "Fernando Jiménez Moreno"
  # s.authors            = { "Fernando Jiménez Moreno" => "ferjmoreno@gmail.com" }
  ...
  s.source       = { :git => "https://github.com/mozilla-magnet/magnet-scanner-ios.git", :tag => "#{s.version}" }
  ...
  s.source_files  = "MagnetScannerIOS"
